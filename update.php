...
$ip = getIP();
$file_name = $_GET['f'];
$file_dir = 'http://www.sq.top/upgrade'; //远程升级补丁存放目录
 ...
 * 升级新版本
 * @package  Common
 * http://sq.weby.cc/update.php?a=update&v=1.2&u=www.0766city.com&key=2c29a500786bccda
 */
...
if($ac=='update'){
	...
	if(!empty($key)){
		if($key != $domain_key){
			echo '<font color=red>KEY错误</font>';	die;
		}
	}else{
