...
<head>
    ...
    <meta name="author" content="0766city.com">
...
<form class="form-signin" name="loginform" method="post" action="###">
        <h2 class="form-signin-heading">域名授权系统登录</h2> 
            <div class="login-wrap">
                      ...
                      <span id='m1'></span><input type="hidden" id='a1' /><input class="form-control" name="username" id="z1" onBlur="" type="text" placeholder="账号" />

                      <span id='m2'></span><input type="hidden" id='a2' /><input class="form-control" name="password" id="z2" onBlur="" type="password" placeholder="密码" />&nbsp;
                                            
					  <input class="form-control" name="safepassword" id="z2" onBlur="" type="password" placeholder="安全码" />
            <div id="bottom">
