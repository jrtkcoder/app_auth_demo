 ...
 ?>
 									<?php 
										...
										if($result&&mysql_num_rows($result)){
											...
											echo "<td >当前（".$row['ip_qh']."）</td>";
											echo "<td >当前（".$row['yumi']."）</td>";
											echo "<td ><span class='label label-success'>".date("Y-m-d",$row['time'])."</span></td>";
											echo "<td >
												<a class='btn btn-primary btn-xs' href='authorize-chanage.php?id=".$row['id']."'><i class='fa fa-edit'></i></a>   <a class='btn btn-primary btn-xs' href='authorize-del.php?id=".$row['id']."'><i class='fa fa-ban'></i></a>
											</td>";
											echo "</tr>";
											}
										}
